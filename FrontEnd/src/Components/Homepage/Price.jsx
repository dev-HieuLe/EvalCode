...
import { Check, Sprout, Flame, Crown, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 md:px-12">
        ...
        >
          Only pay for what you need. No subscriptions, just credits.
        </p>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-16">
          {plans.map((plan, index) => {
            ...
            >
              {plan.featured && (
                <span
                  className="inline-flex items-center gap-2 self-start uppercase mb-3"
                  style={{
                    background: "#ffffff",
                    color: "#000000",
                    borderRadius: 9999,
              ...
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{
                    width: 36,
                    height: 36,
                    background: plan.featured ? "#ffffff" : "#c1fbd4",
                    borderRadius: 9999,
                    color: "#000000",
                  }}
                >
